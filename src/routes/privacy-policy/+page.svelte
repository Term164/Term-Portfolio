...
<svelte:head>
	<title>Jani Bangiev - Privacy policy</title>
</svelte:head>
...
<div class="container">
	<main>
		...
		<ul>
			...
			<li>
				<p>
					...
					or &quot;Our&quot; in this Agreement) refers to Term.
				</p>
			</li>
			<li>
				<p>
			...
			<li>
				<p>
					<strong>Website</strong> refers to Term, accessible from
					<a href="term.si" rel="external nofollow noopener" target="_blank">term.si</a>
				</p>
			</li>
			<li>
				<p>
		...
		<ul>
			<li>By email: jani.bangiev@gmail.com</li>
		</ul>
	</main>
</div>
